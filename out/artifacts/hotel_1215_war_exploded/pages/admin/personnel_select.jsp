                ...
                <div class="col-xs-12">
                    <div class="box">
                        <div class="box-header">
                            <h3 class="box-title">查看所有工作人员信息</h3>
                        </div>
                        <!-- /.box-header -->
                        <div class="box-body">
                            <table id="example1" class="table table-bordered table-striped">
                                ...
                                <tbody>
                                <%
                                    ArrayList<Staff> staffs=(ArrayList<Staff>)session.getAttribute("allStaffs");
                                    for(Staff staff:staffs){
                                %>
                                <tr>
                                    <td><%=staff.getName()%></td>
                                    <td><%=staff.getDocument_type()%></td>
                                    <td><%=staff.getDocument_number()%></td>
