...
<div class="content-wrapper">
    ...
    <section class="content-header">
        ...
        <ol class="breadcrumb">
            ...
            <li><a href="#">房客管理</a></li>
            <li class="active">添加房客信息</li>
        </ol>
    </section>

    <!-- Main content -->
    <section class="content">
        <form method="post" action="../../AddCheckIn.do">
            ...
            <div class="box box-primary">
                    ...
                    <div class="form-group">
                        ...
                        <div class="input-group">
                            ...
                            <select name="document_type" id="document_type" class="form-control">
                                <option value="身份证" id="身份证" name="身份证">身份证</option>
                                <option value="护照" id="护照" name="护照">护照</option>
                            </select>
                        </div>
                    </div>
                ...
                <div class="form-group">
                    ...
                    <div class="input-group">
                        ...
                        <input name="document_number" id="document_number" type="text" class="form-control"
                ...
                <div class="form-group">
                    ...
                    <div class="input-group">
                        ...
                        <input name="gender" id="gender" type="text" class="form-control" data-inputmask='"mask": "男/女"'
                               data-mask>
                    </div>
                </div>
                ...
                <div class="form-group">
                    ...
                    <div class="input-group">
                        ...
                        <input name="checkin_date" id="checkin_date" type="text" class="form-control" placeholder="例：2019-12-17 18:00">
                    </div>
                </div>
                ...
                <div class="form-group">
                    ...
                    <div class="input-group">
                        ...
                        <input name="checkout_date" id="checkout_date" type="text" class="form-control" placeholder="例：2019-12-20 18:00">
                    </div>
                </div>
