...
<div class="content-wrapper">
    ...
    <section class="content-header">
        ...
        <ol class="breadcrumb">
            ...
            <li><a href="#">房间管理</a></li>
            <li class="active">添加房间信息</li>
        </ol>
    </section>

    <!-- Main content -->
    <section class="content">
        <form method="post" action="../../AddRoom.do">

            <div class="box box-primary">
                <div class="box-header">
                    <h3 class="box-title">请输入房间信息</h3>
                </div>
                ...
                <div class="box-body">
                    ...
                    <div class="form-group">
                        ...
                        <div class="input-group">
                            ...
                            <select name="type_id" id="type_id" class="form-control">
                                <option value="1">1普通</option>
                                <option value="2">2高级</option>
                                <option value="3">3豪华</option>
                            </select>
                        </div>
                    </div>
                    ...
                    <div class="input-group">
                        ...
                        <select name="state" id="state" class="form-control">
                            <option value="满" id="满" name="满">满</option>
                            <option value="空" id="空" name="空">空</option>
                        </select>
                    </div>
                </div>
