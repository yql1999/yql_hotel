...
<%@ page import="com.ASH.entity.RoomConsume" %>
    ...
    <div class="content-wrapper">
        ...
        <section class="content-header">
            ...
            <ol class="breadcrumb">
                ...
                <li><a href="#">管理消费信息</a></li>
                <li class="active">查看消费信息</li>
            </ol>
        </section>
                    ...
                    <div class="box">
                        ...
                        <div class="box-body">
                            <table id="example1" class="table table-bordered table-striped">
                                ...
                                <tbody>
                                <%
                                    ArrayList<RoomConsume> arrayList=(ArrayList<RoomConsume>)session.getAttribute("roomConsumeArrayList");
                                    for(RoomConsume roomConsume:arrayList){
                                %>
                                <tr>
                                    <%--<td><%=roomConsume.getId()%></td>--%>
                                    <td><%=roomConsume.getRoomId()%></td>
                                    <td><%=roomConsume.getTime()%></td>
                                    <td><%=roomConsume.getItem()%></td>
                                    <td><%=roomConsume.getPrice()%></td>
                                </tr>
                                <%}%>
                                </tbody>
                            </table>
