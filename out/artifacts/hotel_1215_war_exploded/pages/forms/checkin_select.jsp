<%@ page import="com.ASH.entity.CheckIn" %>
<%@ page import="java.util.ArrayList" %>
<%@ page import="com.ASH.dao.roomDao" %>
<%@ page import="com.ASH.entity.Room" %>
<%@ page import="com.ASH.entity.RoomType" %>
<%@ page import="com.ASH.dao.roomTypeDao" %>
...
<head>
    ...
    <title>查看房客信息界面</title>
    <!-- Tell the browser to be responsive to screen width -->
    <meta content="width=device-width, initial-scale=1, maximum-scale=1, checkin-scalable=no" name="viewport">
    <!-- Bootstrap 3.3.7 -->
            ...
            <div class="col-xs-12">
                <div class="box">
                    <div class="box-header">
                        <h3 class="box-title">查看所有房客信息</h3>
                    </div>
                    <!-- /.box-header -->
                    <div class="box-body">
                        <table id="example1" class="table table-bordered table-striped">
                            ...
                            <tbody>
                            <%
                                ArrayList<CheckIn> checkins=(ArrayList<CheckIn>)session.getAttribute("allCheckIns");
                                for(CheckIn checkin:checkins){
                                    long roomId=checkin.getRoomId();
                                    roomTypeDao roomTypeDao=new roomTypeDao();
                                    RoomType roomType=roomTypeDao.selectById(roomId);
                            %>
                            <tr>
                                <td><%=checkin.getName()%></td>
                                <td><%=checkin.getDocumentType()%></td>
                                <td><%=checkin.getDocumentNumber()%></td>
                                <td><%=checkin.getGender()%></td>
                                <td><%=checkin.getCheckinDate()%></td>
                                <td><%=checkin.getCheckoutDate()%></td>
                                <td><%=checkin.getTime()%></td>
                                <td><%=roomType.getName()%></td>
                                <td><%=checkin.getPhoneNumber()%></td>
                            </tr>
                            <%}%>
                            </tbody>
                        </table>
