<%@ page import="com.ASH.service.checkinServlet" %>
        ...
        <div class="col-xs-12">
          ...
          <div class="box box-primary">
            <div class="box-header with-border">
              ...
              <h3 class="box-title">酒店人流量动态实时统计</h3>
        ...
        <div class="col-md-6">
          <div class="box box-primary">
            <div class="box-header with-border">
              ...
              <h3 class="box-title">每个时间点顾客入住和退房情况统计</h3>
        ...
        <div class="col-md-6">
          ...
          <div class="box box-primary">
            <div class="box-header with-border">
              ...
              <h3 class="box-title">每月酒店入住情况统计</h3>
...
<script>
  $(function () {
    ...
    int[][]num = checkinServlet.checkinEachHour();
    %>
    var sin = [], cos = []
    <%
    ...
    //0入住 1退房
    <% int[][]mouthnum = checkinServlet.CheckInEachMonth();%>
