...
Dates are now in UTC. Also "selected" event -> becomes "plotselected"
...
Dates in time mode are now displayed according to UTC instead of the time
zone of the visitor. This affects the way the Dates should be input;
you'll probably have to offset the Dates according to your local time
...
Time series support. Specify axis.mode: "time", put in Javascript Dates
