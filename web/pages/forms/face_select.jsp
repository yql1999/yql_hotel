    ...
    <section class="content">
            ...
            <div class="box box-primary">
                <div class="box-header">
                    <h3 class="box-title">请上传要的检索的人脸</h3>
                </div>

                <div class="box-body">
                    <form method="post" action="../../faceSel.do" enctype="multipart/form-data">
                    <%--<div class="form-group">
                        ...
                        <div class="input-group">
                            ...
                            <input name="meeting_number" id="meeting_number" type="text" class="form-control">
                        </div>
                    </div>--%>

                    <!-- 上传照片 -->
                    <div class="form-group">
                        <label for="StuPhoto">上传照片：</label>
                        <input type="file" name="StuPhoto" id="StuPhoto" onchange="changepic(this)" accept="image/jpg,image/jpeg,image/png,image/PNG">
                        <img src="" id="imageview" style="display: none">
                        <script>
                            function changepic() {
                                //$("#prompt3").css("display", "none");
                                var reads = new FileReader();
                                f = document.getElementById('StuPhoto').files[0];
                                reads.readAsDataURL(f);
                                reads.onload = function(e) {
                                    document.getElementById('imageview').src = this.result;
                                    $('#imageview').attr("style","width: 150px;height: 200px;display:inline");
                                    //$("#imageview").css("display", "block");
                                };
                            }
                        </script>
                        <p class="help-block">请选择清晰的免冠照片上传</p>
                    </div>
                    </form>
