...
<%@ page import="com.ASH.entity.Visitor" %>
<%@ page import="com.ASH.dao.roomDao" %>
<%@ page import="com.ASH.entity.Room" %>
<%@ page import="com.ASH.dao.checkInDao" %>
...
<div class="content-wrapper">
    ...
    <section class="content-header">
        ...
        <ol class="breadcrumb">
            ...
            <li><a href="#">管理访客信息</a></li>
            <li class="active">查看访客信息</li>
        </ol>
    </section>
                ...
                <div class="box">
                    ...
                    <div class="box-body">
                        <table id="example1" class="table table-bordered table-striped">
                            ...
                            <tbody>
                            <%
                                ArrayList<Visitor> visitors=(ArrayList<Visitor>)session.getAttribute("allVisitors");
                                for(Visitor visitor:visitors){
                                    checkInDao checkInDao=new checkInDao();
                                    CheckIn checkIn=checkInDao.getByRoomId((int)visitor.getRoomId());
                            %>
                            <tr>
                                <td><%=visitor.getName()%></td>
                                <td><%=visitor.getPhoneNumber()%></td>
                                <td><%=visitor.getPower()%></td>
