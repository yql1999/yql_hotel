    ...
    <div class="content-wrapper">
        ...
        <section class="content-header">
            ...
            <ol class="breadcrumb">
                ...
                <li><a href="#">预定管理</a></li>
                <li class="active">添加预定信息</li>
            </ol>
        </section>

        <!-- Main content -->
        <section class="content">
            <form method="post" action="../../AddReserve.do">
                <!-- Default box -->
                <div class="box box-primary">
                    <div class="box-header">
                        <h3 class="box-title">请输入预定信息</h3>
                    </div>
                    ...
                    <div class="box-body">
                        ...
                        <div class="form-group">
                            ...
                            <div class="input-group">
                                ...
                                <input name="checkin_date" id="checkin_date" type="date" class="form-control" placeholder="yyyy-mm-dd">
                            </div>
                        </div>
                        ...
                        <div class="form-group">
                            ...
                            <div class="input-group">
                                ...
                                <input name="checkout_date" id="checkout_date" type="date" class="form-control" placeholder="yyyy-mm-dd">
                            </div>
                        </div>
