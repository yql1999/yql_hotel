<%@ page import="com.ASH.entity.MeetingReserve" %>
<%@ page import="java.util.ArrayList" %>
<%@ page import="com.ASH.entity.MeetingType" %>
<%@ page import="com.ASH.dao.meetingTypeDao" %>
...
<head>
    ...
    <title>查看会议室预定信息界面</title>
    <!-- Tell the browser to be responsive to screen width -->
    <meta content="width=device-width, initial-scale=1, maximum-scale=1, meetingReserve-scalable=no" name="viewport">
    <!-- Bootstrap 3.3.7 -->
...
<div class="content-wrapper">
    ...
    <section class="content-header">
        ...
        <ol class="breadcrumb">
            ...
            <li><a href="#">会议室预定管理</a></li>
            <li class="active">查看会议室预定信息</li>
        </ol>
    </section>
            ...
            <div class="col-xs-12">
                <div class="box">
                    <div class="box-header">
                        <h3 class="box-title">查看所有会议室预定信息</h3>
                    </div>
                    <!-- /.box-header -->
                    <div class="box-body">
                        <table id="example1" class="table table-bordered table-striped">
                            ...
                            <tbody>
                            <%
                                ArrayList<MeetingReserve> meetingReserves=(ArrayList<MeetingReserve>)session.getAttribute("allMeetingReserves");
                                for(MeetingReserve meetingReserve:meetingReserves){
                                    String tmp;
                                    meetingTypeDao meetingTypeDao=new meetingTypeDao();
                                    MeetingType meetingType=meetingTypeDao.selectById(meetingReserve.getMeetingId());
                                    if(meetingReserve.getTimePeriod()==1)
                                        tmp="上午";
                                    else if(meetingReserve.getTimePeriod()==2)
                                        tmp="下午";
                                    else
                                        tmp="晚上";
                            %>
                            <tr>
                                <td><%=meetingReserve.getName()%></td>
                                <td><%=meetingReserve.getPhoneNumber()%></td>
                                <td><%=meetingType.getId()%></td>
                                <td><%=tmp%></td>
                                <td><%=meetingReserve.getInviteCode()%></td>
                            </tr>
                            <%}%>
                            </tbody>
                        </table>
