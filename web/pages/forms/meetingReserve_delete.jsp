...
<div class="content-wrapper">
    ...
    <section class="content-header">
        ...
        <ol class="breadcrumb">
            ...
            <li class="active">删除会议室预定信息</li>
        </ol>
    </section>

    <!-- Main content -->
    <section class="content">
        <form method="post" action="../../DelMeetingReserve.do">
            <!-- Default box -->
            <div class="box box-primary">
                <div class="box-header">
                    <h3 class="box-title">请输入要删除的会议室预定信息</h3>
                </div>
                ...
                <div class="box-body">
                    ...
                    <div class="form-group">
                        ...
                        <div class="input-group">
                            ...
                            <select name="meeting_time" id="meeting_time" class="form-control">
                                <option value="早">7:00——11:00</option>
                                <option value="中">12:00——17:00</option>
                                <option value="晚">18:00——22:00</option>
                                <option value="全天">7:00——22:00</option>
                            </select>
                        </div>
                    </div>
