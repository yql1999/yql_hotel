...
<%@ page import="com.ASH.entity.Meeting" %>
            ...
            <div class="col-xs-12">
                <div class="box">
                    <div class="box-header">
                        <h3 class="box-title">查看所有会议室信息</h3>
                    </div>
                    <!-- /.box-header -->
                    <div class="box-body">
                        <table id="example1" class="table table-bordered table-striped">
                            ...
                            <tbody>
                            <%
                                ArrayList<Meeting> meetings=(ArrayList<Meeting>)session.getAttribute("allMeetings");
                                for(Meeting meeting:meetings){
                                    meetingTypeDao roomTypeDao=new meetingTypeDao();
                                    MeetingType meetingType=roomTypeDao.selectById(meeting.getId());
                            %>
                            <tr>
                                <td><%=meeting.getMeetingNumber()%></td>
                                <td><%=meeting.getTypeId()%></td>
                                <td><%=meetingType.getPrice()%></td>
