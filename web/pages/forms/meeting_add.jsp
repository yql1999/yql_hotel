...
<div class="content-wrapper">
    ...
    <section class="content-header">
        ...
        <ol class="breadcrumb">
            ...
            <li class="active">添加会议室信息</li>
        </ol>
    </section>

    <!-- Main content -->
    <section class="content">
        <form method="post" action="../../AddMeeting.do">

            <div class="box box-primary">
                <div class="box-header">
                    <h3 class="box-title">请输入会议室信息</h3>
                </div>
                    ...
                    <div class="form-group">
                        ...
                        <div class="input-group">
                            ...
                            <select name="type_id" id="type_id" class="form-control">
                                <option value="1">1小型会议室</option>
                                <option value="2">2中型会议室</option>
                                <option value="3">3大型会议室</option>
                            </select>
                        </div>
                    </div>
<%--
                    ...
                    <div class="form-group">
                        ...
                        <div class="input-group">
                            ...
                            <select name="state" id="state" class="form-control">
                                <option value="已预订" id="已预订" name="已预订">已预订</option>
                                <option value="空闲" id="空闲" name="空闲">空闲</option>
                            </select>
                        </div>
                    </div>
