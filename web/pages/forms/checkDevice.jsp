      ...
      <ul class="sidebar-menu" data-widget="tree">
        ...
        <li class="treeview">
          ...
          <ul class="treeview-menu">
            ...
            <li><a href="checkin_add.jsp"><i class="fa fa-circle-o"></i> 增加学生信息</a></li>
            <li><a href="checkin_update.jsp"><i class="fa fa-circle-o"></i> 修改学生信息</a></li>
            <li><a href="checkin_delete.jsp"><i class="fa fa-circle-o"></i> 删除学生信息</a></li>
          </ul>
        </li>
        ...
        <li class="treeview">
          ...
          <ul class="treeview-menu">
            <li><a href="reserve_add.jsp"><i class="fa fa-circle-o"></i> 增加设备信息</a></li>
            <li><a href="reserve_update.jsp"><i class="fa fa-circle-o"></i> 修改设备信息</a></li>
            <li><a href="reserve_delete.jsp"><i class="fa fa-circle-o"></i> 删除设备信息</a></li>
          </ul>
        </li>

        <li class="header">代办</li>
        <li><a href="#"><i class="fa fa-circle-o text-red"></i> <span>设备维护</span></a></li>
