...
<head>
    ...
    <title>查看房间信息界面</title>
    <!-- Tell the browser to be responsive to screen width -->
    <meta content="width=device-width, initial-scale=1, maximum-scale=1, room-scalable=no" name="viewport">
    <!-- Bootstrap 3.3.7 -->
            ...
            <div class="col-xs-12">
                <div class="box">
                    <div class="box-header">
                        <h3 class="box-title">查看所有房间信息</h3>
                    </div>
                    <!-- /.box-header -->
                    <div class="box-body">
                        <table id="example1" class="table table-bordered table-striped">
                            ...
                            <tbody>
                            <%
                                ArrayList<Room> rooms=(ArrayList<Room>)session.getAttribute("allRooms");
                                String s="../../dist/img/bed1.jpg";
                                for(Room room:rooms){
                                    roomTypeDao roomTypeDao=new roomTypeDao();
                                    RoomType roomType=roomTypeDao.selectById(room.getId());
                                    if (roomType.getName()=="高级")
                                        s ="../../dist/img/bed2.jpg";
                                    else if (roomType.getName()=="豪华")
                                        s ="../../dist/img/bed3.jpg";
                            %>
                            <tr>
                                <td><%=room.getId()%></td>
