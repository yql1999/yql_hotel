...
<div class="content-wrapper">
    ...
    <section class="content-header">
        ...
        <ol class="breadcrumb">
            ...
            <li class="active">添加工作人员信息</li>
        </ol>
    </section>

    <!-- Main content -->
    <section class="content">
        <form method="post" action="AddStaff.do">

            <div class="box box-primary">
                <div class="box-header">
                    <h3 class="box-title">请输入工作人员信息</h3>
                </div>
                ...
                <div class="box-body">
                    ...
                    <div class="form-group">
                        ...
                        <div class="input-group">
                            ...
                            <input name="checkin_date" id="checkin_date" type="text" class="form-control"
                                   placeholder="例：2019-12-17">
                        </div>
                    </div>--%>
